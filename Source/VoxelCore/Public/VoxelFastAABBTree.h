...
public:
	...
	static TSharedRef<FVoxelFastAABBTree> Create(FElementArray&& Elements);
	static TSharedRef<FVoxelFastAABBTree> Create(TConstVoxelArrayView<FVoxelBox> Bounds);
...
private:
	FVoxelFastBox RootBounds = FVoxelFastBox(FVoxelBox::InvertedInfinite);
