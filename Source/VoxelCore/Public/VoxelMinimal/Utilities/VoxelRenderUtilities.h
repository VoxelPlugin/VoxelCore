...
#define VOXEL_DEBUG_SHADER(Name) \
	VOXEL_SHADER_MODIFY_COMPILATION_ENVIRONMENT(Name) \
	{ \
		Environment.CompilerFlags.Add(CFLAG_SkipOptimizations); \
		Environment.CompilerFlags.Add(CFLAG_GenerateSymbols); \
	}
